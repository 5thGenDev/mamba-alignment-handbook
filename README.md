...
### Why not mamba?
Since Mamba is in its infant state in R&D right now. It won't receive speed boosts unsloth and if I'm being frank here, I'm not sure if QLora will mess up Mamba but that's why we are here as researchers - to test and share.
