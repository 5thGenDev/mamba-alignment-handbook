...
pip install causal_conv1d-1.1.1+cu118torch2.1cxx11abiFALSE-cp38-cp38-linux_x64_64.whl
pip install mamba_ssm-1.1.1+cu118torch2.1cxx11abiFALSE-cp38-cp38-linux_x86_64.whl
